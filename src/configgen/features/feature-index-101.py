...
class IndexHandler:
 """Processes index requests with retries and timeouts."""
 ...
 return {"index": str(payload)[:200], "attempts": 0}
...
def run_index(payload, **options):
 """Module-level convenience entry point."""
 return IndexHandler().run(payload, **options)